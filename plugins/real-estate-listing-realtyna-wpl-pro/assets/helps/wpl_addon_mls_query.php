...
$content = '<h3>'.__('MLS Addon / Query Wizard', 'wpl').'</h3><p>'.__("Here you can create some queries for filtering MLS/RETS listing and then import them to your website.", 'wpl').'</p>';
