...
class wpl_save_searches_widget extends wpl_widget
{
    ...
    {
        parent::__construct('wpl_save_searches_widget', __('(WPL) Save Searches', 'wpl'), array('description'=>__('Shows saved searches.', 'wpl')));
    }
    ...
    public function form($instance)
    {
        ...
        {
            $instance = array('title'=>__('Save Searches', 'wpl'), 'layout'=>'default',
                'data'=>array(
                    'css_class'=>'',
            ));
