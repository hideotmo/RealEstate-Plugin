...
/**
 * WPL Theme28 SCSS Library
 * @author Howard <howard@realtyna.com>
 * @since WPL Theme28 2.1.0
 * @date 08/25/2015
 * @package WPL Theme28
 */
class wpl_theme28_scss
{
    /**
     ...
     * @var string
     */
    public $formatter = 'wpl_theme28_scss_formatter_compressed';
    ...
    {
        $this->scssc = new wpl_theme28_scssc();
        
        $this->set_import_path(WPLT_ABSPATH.'assets'.DS.'scss'.DS);
    ...
    public function set_formatter($formatter)
    {
        ...
        if(strpos($formatter, 'wpl_theme28_') === false) $formatter = 'wpl_theme28_'.$formatter;
 ...
 * by `wpl_theme28_scss_parser` into a syntax tree, then it is compiled into another tree
 * representing the CSS structure by `wpl_theme28_scssc`. The CSS tree is fed into a
 * formatter, like `wpl_theme28_scss_formatter` which then outputs CSS as a string.
 *
 * During the first compile, all values are *reduced*, which means that their
 * types are brought to the lowest form before being dump as strings. This
 * handles math equations, variable dereferences, and the like.
 *
 * The `parse` function of `wpl_theme28_scssc` is the entry point.
 *
 * In summary:
 *
 * The `wpl_theme28_scssc` class creates an instance of the parser, feeds it SCSS code,
 * then transforms the resulting tree to a CSS tree. This class also holds the
 * evaluation context, such as all available mixins and variables at any given
 * time.
 *
 * The `wpl_theme28_scss_parser` class is only concerned with parsing its input.
 *
 * The `wpl_theme28_scss_formatter` takes a CSS tree, and dumps it to a formatted string,
...
class wpl_theme28_scssc {
	...
	protected $formatter = "wpl_theme28_scss_formatter_nested";
	...
	public function compile($code, $name = null)
	{
		...
		$this->parser = new wpl_theme28_scss_parser($name);
	...
	protected function injectVariables(array $args)
	{
		...
		$parser = new wpl_theme28_scss_parser(__METHOD__, false);
	...
	protected function importFile($path, $out) {
		...
		if (isset($this->importCache[$realPath])) {
			...
			$parser = new wpl_theme28_scss_parser($path, false);
...
class wpl_theme28_scss_parser {
	...
	static protected function makeOperatorStr($operators) {
		return '('.implode('|', array_map(array('wpl_theme28_scss_parser','preg_quote'),
			$operators)).')';
	}
	 ...
	 *
	 * Consider the function wpl_theme28_scssc::keyword(). (All parse functions are
	 * structured the same.)
	 *
	 ...
	 *
	 * All of these parse functions are powered by wpl_theme28_scssc::match(), which behaves
	 ...
	 * avoid this, wpl_theme28_scssc::seek() is used to remember and set buffer positions.
	 *
	...
	protected function selectorSingle(&$out) {
		...
		while (true) {
			...
			// self
			if ($this->literal("&", false)) {
				$parts[] = wpl_theme28_scssc::$selfSelector;
				continue;
			}
 ...
 * @author Leaf Corcoran <leafot@gmail.com>
 */
class wpl_theme28_scss_formatter {
	public $indentChar = "  ";
 ...
 * @author Leaf Corcoran <leafot@gmail.com>
 */
class wpl_theme28_scss_formatter_nested extends wpl_theme28_scss_formatter {
	public $close = " }";
 ...
 * @author Leaf Corcoran <leafot@gmail.com>
 */
class wpl_theme28_scss_formatter_compressed extends wpl_theme28_scss_formatter {
	public $open = "{";
	public $tagSeparator = ",";
	public $assignSeparator = ":";
	public $break = "";
...
class wpl_theme28_scss_server {
	 ...
	 * @param \wpl_theme28_scssc|null $scss     SCSS compiler instance
	 */
