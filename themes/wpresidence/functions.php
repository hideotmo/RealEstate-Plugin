...
add_action( 'wp_ajax_action_load_markers', 'load_markers_from_file' );
add_action( 'wp_ajax_nopriv_action_load_markers', 'load_markers_from_file' );

function load_markers_from_file () {
