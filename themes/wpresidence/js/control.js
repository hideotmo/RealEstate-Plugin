...
jQuery(document).ready(function ($) {
   "use strict";
	...
	//New Adition for exta slider reange
	wpestate_enable_slider('slider_price2', 'price_low2', 'price_max2', 'amount2', my_custom_curr_pos, my_custom_curr_symbol, my_custom_curr_cur_post,my_custom_curr_coef);
	wpestate_enable_slider('slider_price3', 'price_low3', 'price_max3', 'amount3', my_custom_curr_pos, my_custom_curr_symbol, my_custom_curr_cur_post,my_custom_curr_coef);
	wpestate_enable_slider('slider_price_widget_custom', 'price_low_widget4', 'price_max_widget4', 'amount4', my_custom_curr_pos, my_custom_curr_symbol, my_custom_curr_cur_post,my_custom_curr_coef);
		
    $( "#slider_price,#slider_price2,#slider_price3,#slider_price_widget_custom" ).slider({
