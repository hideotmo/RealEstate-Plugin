...
<?php }else{ ?>
    <div class="user_menu" id="user_menu_u">   
        ...
        <div class="submit_action"><?php _e('Sign up/Login','wpestate');?></div>
<?php } ?>   
...
if ( 0 != $current_user->ID  && is_user_logged_in() ) {
	...
	$my_properties          =   home_url().'/my-properties/';
...
?> 
    <ul id="user_menu_open" class="dropdown-menu menulist topmenux" role="menu" aria-labelledby="user_menu_trigger"> 
        ...
        <?php if($home_url!=$my_properties){?>
         <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php print esc_url($my_properties);?>"     class="active_dash"><i class="fa fa-map-marker"></i><?php _e('My Properties','wpestate');?></a></li>
        ...
        <?php if($home_url!=$dash_link){?>
         <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php print esc_url($dash_link);?>"     class="active_dash"><i class="fa fa-map-marker"></i><?php _e('My Condos','wpestate');?></a></li>
