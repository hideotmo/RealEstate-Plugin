...
<div class="<?php echo esc_html($col_class);?> listing_wrapper" data-org="<?php echo esc_html($col_org);?>" data-listid="<?php echo intval($post->ID);?>" > 
    <div class="property_listing" data-link="<?php   if(  $property_unit_slider==0){ echo esc_url($link);}?>">
        ...
        if ( has_post_thumbnail() ){
            ...
            $thumb_prop             = "<img width='525' height='328' src='http://korerealtygroup.ca/wp-content/uploads/2016/09/image-79805546-0-525x328.jpg' class='lazyload img-responsive wp-post-image' alt='image-79805546-0.jpg' data-original='http://localhost/korerealtygroup/wp-content/uploads/2016/09/image-79805546-0-525x328.jpg'>";
