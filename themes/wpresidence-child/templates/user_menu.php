...
$my_properties          =   get_bloginfo( 'url' ).'/my-properties/';
$activeprofile          =   '';
$activedash             =   '';
$activeadd              =   '';
$activefav              =   '';
...
}elseif( basename( get_page_template() ) == 'user_deshboard_non_condo.php'){
	$myproperties  =   'user_tab_active'; 
}
?>
...
<div class="user_tab_menu">
    ...
    <div class="user_dashboard_links">
        ...
        <?php } ?>
        <?php if( $my_properties!=$home_url ){ ?>
            <a href="<?php print esc_url($my_properties);?>"     class="<?php print $myproperties; ?>"> <i class="fa fa-map-marker"></i> <?php _e('My Properties','wpestate');?></a>
        <?php } ?>
        <?php if( $dash_link!=$home_url ){ ?>
            <a href="<?php print esc_url($dash_link);?>"     class="<?php print $activedash; ?>"> <i class="fa fa-map-marker"></i> <?php _e('My Condos','wpestate');?></a>
        <?php } ?>
