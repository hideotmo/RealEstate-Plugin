...
<script type="text/javascript">
  jQuery(document).ready(function(e) {
	 jQuery('ul#menu-communities li.menu-item-has-children').attr('data-id','0');

	 jQuery('ul#menu-communities li.active').children('ul.sub-menu').slideUp();
	 jQuery('ul#menu-communities li.active').removeClass('active');	
	 jQuery('ul#menu-communities li.active').attr('data-id','0');	 	 
	 
     jQuery('ul#menu-communities > li.menu-item-has-children').click(function(e) {
		 var children = jQuery(this).attr('data-id');
		 if(children==0){
